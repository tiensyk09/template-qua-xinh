...
export default function PostSidebarClient({ recentUpdates = [], suggestedProducts = [] }) {
  ...
  return (
    <aside style={{ display: 'flex', flexDirection: 'column', gap: '24px', position: 'sticky', top: '130px', alignSelf: 'flex-start' }}>
      ...
      {/* 1. Contact CTA - Quà Xinh */}
      <div style={{
        background: 'linear-gradient(135deg, #b85c78 0%, #0a4f26 100%)',
        color: '#ffffff',
        borderRadius: '16px',
        padding: '24px',
        ...
        <p style={{ fontSize: '13px', lineHeight: 1.5, opacity: 0.9, margin: '0 0 16px 0' }}>
          Liên hệ trực tiếp để được tư vấn chọn quà tặng và phụ kiện xinh xắn chính hãng, tận tâm 24/7.
        </p>
      ...
      {suggestedProducts.length > 0 && (
        <div style={{
          ...
          <h3 style={{ fontSize: '15px', fontWeight: 800, color: '#4a2a38', marginBottom: '16px', display: 'flex', alignItems: 'center', gap: '8px', borderBottom: '2px solid #fdeef5', paddingBottom: '8px' }}>
                ...
                <div key={prod.id} style={{ display: 'flex', flexDirection: 'column', gap: '8px', paddingBottom: '12px', borderBottom: '1px solid #f3f4f6' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', minWidth: 0 }}>
                      ...
                      <div>
                        <div style={{ display: 'flex', alignItems: 'baseline', gap: '4px', flexWrap: 'wrap' }}>
                          <span style={{ fontSize: '13.5px', fontWeight: 700, color: '#b85c78' }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      color: addingId === prod.id ? '#fff' : '#b85c78',
                      fontWeight: 700,
                      fontSize: '11.5px',
                      cursor: 'pointer',
                      display: 'flex',
                    ...
                    onMouseEnter={(e) => {
                      if (addingId !== prod.id) {
                        e.currentTarget.style.background = '#b85c78';
                        e.currentTarget.style.color = '#fff';
                      }
                    }}
                    onMouseLeave={(e) => {
                      if (addingId !== prod.id) {
                        e.currentTarget.style.background = '#fceaf0';
                        e.currentTarget.style.color = '#b85c78';
                      }
                    }}
                  >
