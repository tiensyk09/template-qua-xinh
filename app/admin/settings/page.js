  ...
  async function loadSettings() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setHeader({
          logoText: s.header_logo_text || 'Quà Xinh',
                ...
                <div className="adm-card-body" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  ...
                  <div className="adm-form-group">
                    ...
                    <input
                      ...
                      placeholder="e.g. quà tặng, phụ kiện, móc khóa, quà sinh nhật"
                    />
                  </div>
                </div>
              </div>
                ...
                <div className="adm-card-body" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                  <div className="adm-form-group">
                    ...
                    <input
                      ...
                      placeholder="e.g. © 2026 Quà Xinh. All rights reserved."
                    />
                  </div>
